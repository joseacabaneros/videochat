...
module.exports.profile = function (req, res, next) {
    res.render('profile', {
        ...
        lang: {
            ...
            fieldSizeCheck: 'The value must have between 3 and 20 characters',
            emailCheck: 'Email must have valid',
            hello: 'Hello',
    ...
    if (req.sub == false) {
        res.render('register', {
            ...
            lang: {
                ...
                loginHere: 'Login!',
                fieldPatternCheck: 'The value must have between 8 and 20 characters, number, character and uppercase',
                emailCheck: 'Email must have valid',
                checking: 'Checking...',
                name: 'Name',
                surname: 'Surname',
                email: 'Email',
                nameEnter: 'Enter your name',
                surnameEnter: 'Enter your surname',
                emailEnter: 'Enter your email',
                nameRequired: 'Tell us your name',
                surnameRequired: 'Tell us your surname',
...
module.exports.multichat = function (req, res, next) {
    res.render('multichat', {
        ...
        lang: {
            ...
            streamingAdaptative: "Adaptative Streaming (MPEG-DASH in Apache)",
